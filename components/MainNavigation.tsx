...
export default function MainNavigation(props: {menus:Menu[]}) {

    function toggleMenu()
    {
        document.querySelector(['.',classes.menu].join(''))?.classList.toggle(classes.show);
        document.querySelector(['.',classes.barBtn].join(''))?.classList.toggle(classes.hide);
        document.querySelector(['.',classes.closeBtn].join(''))?.classList.toggle(classes.hide);
    };
    return (
        <>
            <div className={classes.menuBtn} onClick={toggleMenu}>
                <span className={classes.barBtn}>
                ...
                <span className={[classes.closeBtn, classes.hide].join(' ')}>
