...
const CameraDesignerBlog: NextPage<BlogProps> = (props: BlogProps) => {
  return (
      <>  
...
export default CameraDesignerBlog;

export const getStaticPaths: GetStaticPaths = async () => {
    return await GetStaticPropHelper.getBlogListStaticPaths("Camera Designer");
}
